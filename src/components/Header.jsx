            ...
            <div className="container flex items-center justify-between">
                ...
                <div className="flex items-center space-x-5 text-white text-sm" role="navigation" aria-label="Accessibility controls">
                    ...
                    <button
                        ...
                        className="border border-white w-12 h-12 text-sm font-bold hover:bg-white hover:text-black transition focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
